...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2a40b2ac-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/row/src/main.vue?vue&type=template&id=7df16573&
var mainvue_type_template_id_7df16573_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"yx-row"},[(_vm.title)?_c('div',{staticClass:"title-wrap"},[_c('h3',[_vm._v(_vm._s(_vm.title))]),_c('div',{staticClass:"header"},[_vm._t("header")],2)]):_vm._e(),_c('div',{staticClass:"wrap-border"},_vm._l((_vm.row),function(item,index){return _c('div',{key:item['label']+index,staticClass:"margin-btm",style:({ width: !item['span'] ? '25%' : ((100 / item['span']) + "%") })},[_c('div',{staticClass:"label label-style",class:{'label-span-sty': item['span']},style:(item.lineStyle ? item.lineStyle : '')},[_c('el-tooltip',{attrs:{"effect":"dark","disabled":!item['tip'],"content":item['label']}},[_c('span',[_vm._v(_vm._s(item['label']))])])],1),(item['render'])?_c('div',{staticClass:"label-con label-con-style",class:{'label-con-span-sty': item['span']}},[_c('row-render',{attrs:{"scope":_vm.source,"render":item['render']}})],1):_c('div',{staticClass:"label-con label-con-style",class:{'label-con-span-sty': item['span']},style:(item.spanStyle ? item.spanStyle : '')},[(_vm.source)?_c('span',[(item['link'])?_c('span',{directives:[{name:"explore",rawName:"v-explore",value:({exploreList: _vm.exploreList, key: _vm.source[item['key']]}),expression:"{exploreList, key: source[item['key']]}"}],staticClass:"text-link"},[_vm._v(_vm._s(_vm.source[item['key']]))]):(item['map'])?_c('span',{directives:[{name:"map",rawName:"v-map",value:({address: _vm.source[item['key']]}),expression:"{address: source[item['key']]}"}],staticClass:"text-link"},[_vm._v(_vm._s(_vm.source[item['key']]))]):_c('span',[_vm._v(_vm._s(_vm.source[item['key']]))])]):_vm._e()])])}),0),_vm._t("default"),_c('div',{staticClass:"footer"},[_vm._t("footer")],2)],2)}
var mainvue_type_template_id_7df16573_staticRenderFns = []


// CONCATENATED MODULE: ./packages/row/src/main.vue?vue&type=template&id=7df16573&
...
var row_src_main_component = normalizeComponent(
  ...
  mainvue_type_template_id_7df16573_render,
  mainvue_type_template_id_7df16573_staticRenderFns,
  false,
  null,
  null,
  null
