 ...
 * */
      ...
      // CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"665cf04e-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/page-table/src/main.vue?vue&type=template&id=d3bd59dc&
      var mainvue_type_template_id_d3bd59dc_render = function () {
        var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return _c('div', { ref: 'pageTable', staticClass: 'yx-page-table' }, [_c('el-table', _vm._g(_vm._b({ directives: [{ name: 'loading', rawName: 'v-loading', value: (_vm.loading), expression: 'loading' }], ref: 'elTable', attrs: { border: '', data: _vm.data, 'cell-style': _vm.cellStyle, 'span-method': _vm.merge ? _vm.mergeMethod : _vm.spanMethod, 'row-class-name': _vm.tableRowClassName, 'cell-class-name': _vm.cellClassName } }, 'el-table', _vm.$attrs, false), _vm.$listeners), _vm._l((_vm.column), function (item, index) { return _c('table-column', _vm._b({ key: index, attrs: { column: item } }, 'table-column', _vm.$attrs, false)) }), 1), (_vm.pagination) ? _c('el-pagination', _vm._g(_vm._b({
          ...
          attrs: { layout: 'total, sizes, prev, pager, next, jumper', 'current-page': _vm.currentPage1, 'page-sizes': [20, 30, 50] },
          on: { 'update:currentPage': function ($event) { _vm.currentPage1 = $event }, 'update:current-page': function ($event) { _vm.currentPage1 = $event }, 'current-change': _vm.paginationCurrentChange }
        }, 'el-pagination', _vm.$attrs, false), _vm.$listeners)) : _vm._e()], 1) 
      }
      var mainvue_type_template_id_d3bd59dc_staticRenderFns = []

      // CONCATENATED MODULE: ./packages/page-table/src/main.vue?vue&type=template&id=d3bd59dc&
      ...
      var src_main_component = normalizeComponent(
        ...
        mainvue_type_template_id_d3bd59dc_render,
        mainvue_type_template_id_d3bd59dc_staticRenderFns,
        false,
        null,
        null,
        null
