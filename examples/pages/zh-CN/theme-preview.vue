...
<script>
import bus from 'examples/bus.js'
import ThemeConfigurator from 'examples/components/theme-configurator'
import ComponentsPreview from 'examples/components/theme/components-preview'
import BasicTokensPreview from 'examples/components/theme/basic-tokens-preview'
import {
  loadPreviewFromLocal,
  loadUserThemeFromLocal,
  saveUserThemeToLocal
} from 'examples/components/theme/localstorage'
import {
  getThemeConfigObject
} from 'examples/components/theme/utils'
import {
  ACTION_APPLY_THEME
} from 'examples/components/theme/constant.js'
import throttle from 'throttle-debounce/throttle'
import { getActionDisplayName } from 'examples/components/theme-configurator/utils/utils'
